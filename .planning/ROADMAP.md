...
**Plans**: 3 plans
- [x] 12-01-PLAN.md — Draft storage service and data model
- [x] 12-02-PLAN.md — Draft commands (list, delete)
- [x] 12-03-PLAN.md — Send command draft integration (save-draft, load-draft)
...
| 12. Draft Management | v1.1 | 3/3 | Complete | 2026-04-05 |
