...
- **Global scope**: `/home/laffy/Desktop/mail-cli/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/laffy/Desktop/mail-cli/.claude/notes/`)
...
2. Glob `/home/laffy/Desktop/mail-cli/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/laffy/Desktop/mail-cli/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/laffy/Desktop/mail-cli/.claude/notes/` — works in any directory
