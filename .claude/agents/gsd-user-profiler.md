...
<reference>
@/home/laffy/Desktop/mail-cli/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/laffy/Desktop/mail-cli/.claude/get-shit-done/references/user-profiling.md` to load:
