...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/laffy/Desktop/mail-cli/.claude
                  → checks /home/laffy/Desktop/mail-cli/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/laffy/Desktop/mail-cli/.claude/get-shit-done
                  → writes to /home/laffy/Desktop/mail-cli/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "/home/laffy/Desktop/mail-cli/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/laffy/Desktop/mail-cli/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/laffy/Desktop/mail-cli/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
